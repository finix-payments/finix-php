...
/**
 * UpdatePayoutProfileRequestNet Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdatePayoutProfileRequestNet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePayoutProfileRequest_net';
     ...
     * Sets frequency
     *
     * @param string|null $frequency Configures how frequentyly fees *and* payouts get credited.
     *
     * @return self
     */
     ...
     *
     * @param int|null $submission_delay_days Include a number of `submission_delay_days` to delay when `funding_transfers` for both payouts *and* fees get submitted (in days) to debit/credit the `payment_instrument_id`.
     *
     * @return self
     */
