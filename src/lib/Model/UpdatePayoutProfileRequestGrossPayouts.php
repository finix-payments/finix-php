...
/**
 * UpdatePayoutProfileRequestGrossPayouts Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdatePayoutProfileRequestGrossPayouts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePayoutProfileRequest_gross_payouts';
     ...
     * Sets frequency
     *
     * @param string|null $frequency Configures how frequentyly **payouts** get credited. To configure a **CUSTOM** `frequency` [contact Finix Support](/guides/payouts/).
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_instrument_id The `id` of the `Payment Instrument`that payouts will get credited to.
     *
     * @return self
     */
     ...
     * Sets rail
     *
     * @param string|null $rail Configures how quickly and which payment `rail` will be used to credit **payouts**.
     *
     * @return self
     */
     ...
     *
     * @param int|null $submission_delay_days Include a number of `submission_delay_days` to delay when `funding_transfers` for `payouts` will get submitted to credit (in days) the `payment_instrument_id`.
     *
     * @return self
     */
