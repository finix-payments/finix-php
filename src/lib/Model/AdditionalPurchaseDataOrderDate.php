...
/**
 * AdditionalPurchaseDataOrderDate Class Doc Comment
 *
 * @category Class
 * @package  Finix
 * @author   Finix
 ...
 */
class AdditionalPurchaseDataOrderDate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdditionalPurchaseData_order_date';
