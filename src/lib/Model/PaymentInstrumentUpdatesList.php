...
/**
 * PaymentInstrumentUpdatesList Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Finix
 ...
 */
class PaymentInstrumentUpdatesList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentInstrumentUpdatesList';
     ...
     * Gets _embedded
     *
     * @return \Finix\Model\PaymentInstrumentUpdatesListEmbedded|null
     */
     ...
     * Sets _embedded
     *
     * @param \Finix\Model\PaymentInstrumentUpdatesListEmbedded|null $_embedded _embedded
     *
     * @return self
     */
