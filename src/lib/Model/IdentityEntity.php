...
/**
 * IdentityEntity Class Doc Comment
 *
 * @category Class
 ...
 */
class IdentityEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Identity_entity';
    ...
    public function setBusinessName($business_name, $deserialize = false)
    {
        ...
        if (!is_null($business_name) && (mb_strlen($business_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $business_name when calling IdentityEntity., must be bigger than or equal to 1.');
        }
    ...
    public function setBusinessPhone($business_phone, $deserialize = false)
    {
        ...
        if (!is_null($business_phone) && (mb_strlen($business_phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $business_phone when calling IdentityEntity., must be bigger than or equal to 1.');
        }
    ...
    public function setDefaultStatementDescriptor($default_statement_descriptor, $deserialize = false)
    {
        ...
        if (!is_null($default_statement_descriptor) && (mb_strlen($default_statement_descriptor) < 1)) {
            throw new \InvalidArgumentException('invalid length for $default_statement_descriptor when calling IdentityEntity., must be bigger than or equal to 1.');
        }
    ...
    public function setDoingBusinessAs($doing_business_as, $deserialize = false)
    {
        ...
        if (!is_null($doing_business_as) && (mb_strlen($doing_business_as) < 1)) {
            throw new \InvalidArgumentException('invalid length for $doing_business_as when calling IdentityEntity., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail($email, $deserialize = false)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling IdentityEntity., must be bigger than or equal to 1.');
        }
    ...
    public function setFirstName($first_name, $deserialize = false)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling IdentityEntity., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name, $deserialize = false)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling IdentityEntity., must be bigger than or equal to 1.');
        }
    ...
    public function setMcc($mcc, $deserialize = false)
    {
        ...
        if (!is_null($mcc) && (mb_strlen($mcc) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mcc when calling IdentityEntity., must be bigger than or equal to 1.');
        }
    ...
    public function setOwnershipType($ownership_type, $deserialize = false)
    {
        ...
        if (!is_null($ownership_type) && (mb_strlen($ownership_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ownership_type when calling IdentityEntity., must be bigger than or equal to 1.');
        }
    ...
    public function setPhone($phone, $deserialize = false)
    {
        ...
        if (!is_null($phone) && (mb_strlen($phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling IdentityEntity., must be bigger than or equal to 1.');
        }
    ...
    public function setTitle($title, $deserialize = false)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling IdentityEntity., must be bigger than or equal to 1.');
        }
    ...
    public function setUrl($url, $deserialize = false)
    {
        ...
        if (!is_null($url) && (mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling IdentityEntity., must be bigger than or equal to 1.');
        }
