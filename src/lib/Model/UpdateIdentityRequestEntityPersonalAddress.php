 ...
 */
class UpdateIdentityRequestEntityPersonalAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateIdentityRequest_entity_personal_address';
