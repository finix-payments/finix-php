...
/**
 * PayoutProfileGrossFees Class Doc Comment
 *
 * @category Class
 ...
 */
class PayoutProfileGrossFees implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayoutProfile_gross_fees';
