...
/**
 * CreateProcessorRequest Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Finix
 ...
 */
class CreateProcessorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateProcessorRequest';
