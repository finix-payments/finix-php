...
/**
 * CreateIdentityRequestAdditionalUnderwritingDataVolumeDistributionByBusinessType Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateIdentityRequestAdditionalUnderwritingDataVolumeDistributionByBusinessType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateIdentityRequest_additional_underwriting_data_volume_distribution_by_business_type';
     ...
     *
     * @param int|null $person_to_person_volume_percentage The percentage of the merchant's volume that's person to person (between 0 and 100).
     *
     * @return self
     */
