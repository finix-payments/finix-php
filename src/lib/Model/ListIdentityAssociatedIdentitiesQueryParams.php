...
/**
 * ListIdentityAssociatedIdentitiesQueryParams Class Doc Comment
 *
 * @category Class
 * @package  Finix
 * @author   Finix
 ...
 */
class ListIdentityAssociatedIdentitiesQueryParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListIdentityAssociatedIdentitiesQueryParams';
