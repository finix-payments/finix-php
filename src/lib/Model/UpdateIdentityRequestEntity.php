...
class UpdateIdentityRequestEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets email
     *
     * @param string|null $email The email address of the buyer (max 100 characters).
     *
     * @return self
     */
     ...
     * Sets first_name
     *
     * @param string|null $first_name The legal first name of the buyer (max 20 characters).
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string|null $last_name The legal last name of the buyer (max 20 characters).
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string|null $phone Phone number where the buyer can be reached.
     *
     * @return self
     */
