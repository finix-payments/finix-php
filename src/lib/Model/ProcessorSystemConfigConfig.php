...
/**
 * ProcessorSystemConfigConfig Class Doc Comment
 *
 * @category Class
 ...
 */
class ProcessorSystemConfigConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Processor_system_config_config';
    ...
    protected static $openAPITypes = [
        'can_debit_bank_account' => 'array<string,object>'
    ];
     ...
     *
     * @param array<string,object>|null $can_debit_bank_account Set to true to allow the `Processor` to debit `Payment instrument with type **BANK_ACCOUNT** (i.e. eCheck).
     *
     * @return self
     */
