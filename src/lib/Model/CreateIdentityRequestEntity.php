...
/**
 * CreateIdentityRequestEntity Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateIdentityRequestEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateIdentityRequest_entity';
     ...
     * Sets email
     *
     * @param string|null $email The email address of the buyer where they can be reached (max 100 characters).
     *
     * @return self
     */
     ...
     *
     * @return \Finix\Model\CreateIdentityRequestEntityPersonalAddress|null
     */
     ...
     *
     * @param \Finix\Model\CreateIdentityRequestEntityPersonalAddress|null $personal_address personal_address
     *
     * @return self
     */
