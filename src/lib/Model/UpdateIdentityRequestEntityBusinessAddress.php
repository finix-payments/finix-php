...
/**
 * UpdateIdentityRequestEntityBusinessAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateIdentityRequestEntityBusinessAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateIdentityRequest_entity_business_address';
    ...
    public function setCity($city, $deserialize = false)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling UpdateIdentityRequestEntityBusinessAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setCountry($country, $deserialize = false)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) < 1)) {
            throw new \InvalidArgumentException('invalid length for $country when calling UpdateIdentityRequestEntityBusinessAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setRegion($region, $deserialize = false)
    {
        ...
        if (!is_null($region) && (mb_strlen($region) < 1)) {
            throw new \InvalidArgumentException('invalid length for $region when calling UpdateIdentityRequestEntityBusinessAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setLine2($line2, $deserialize = false)
    {
        ...
        if (!is_null($line2) && (mb_strlen($line2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $line2 when calling UpdateIdentityRequestEntityBusinessAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setLine1($line1, $deserialize = false)
    {
        ...
        if (!is_null($line1) && (mb_strlen($line1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $line1 when calling UpdateIdentityRequestEntityBusinessAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postal_code, $deserialize = false)
    {
        ...
        if (!is_null($postal_code) && (mb_strlen($postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling UpdateIdentityRequestEntityBusinessAddress., must be bigger than or equal to 1.');
        }
