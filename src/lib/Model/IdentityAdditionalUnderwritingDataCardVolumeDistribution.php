...
/**
 * IdentityAdditionalUnderwritingDataCardVolumeDistribution Class Doc Comment
 *
 * @category Class
 ...
 */
class IdentityAdditionalUnderwritingDataCardVolumeDistribution implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Identity_additional_underwriting_data_card_volume_distribution';
     ...
     *
     * @param int|null $mail_order_telephone_order_percentage The percentage of the merchant's business that is a mail or telephone order (between 0 and 100).
     *
     * @return self
     */
