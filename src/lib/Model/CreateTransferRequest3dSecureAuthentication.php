...
/**
 * CreateTransferRequest3dSecureAuthentication Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateTransferRequest3dSecureAuthentication implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTransferRequest_3d_secure_authentication';
