...
/**
 * Error402PaymentRequiredEmbeddedErrorsInner Class Doc Comment
 *
 * @category Class
 * @package  Finix
 * @author   Finix
 ...
 */
class Error402PaymentRequiredEmbeddedErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Error402PaymentRequired__embedded_errors_inner';
    ...
    public const CODE_CALL_ISSUER = 'CALL_ISSUER';
    public const MESSAGE_PLEASE_CONTACT_CARD_ISSUER_FOR_MORE_INFORMATION = 'Please contact card issuer for more information.';
    ...
    {
        return [
            self::MESSAGE_PLEASE_CONTACT_CARD_ISSUER_FOR_MORE_INFORMATION,
        ];
    }
