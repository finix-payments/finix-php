...
/**
 * CreateIdentityRequestAdditionalUnderwritingDataCardVolumeDistribution Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateIdentityRequestAdditionalUnderwritingDataCardVolumeDistribution implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateIdentityRequest_additional_underwriting_data_card_volume_distribution';
     ...
     *
     * @param int|null $card_present_percentage The percentage of the merchant's volume that's card present (between 0 and 100).
     *
     * @return self
     */
     ...
     *
     * @param int|null $mail_order_telephone_order_percentage The percentage of the merchant's business that is a mail order or telephone order (between 0 and 100).
     *
     * @return self
     */
     ...
     *
     * @param int|null $ecommerce_percentage The percentage of the merchant's business that is eCommerce (between 0 and 100).
     *
     * @return self
     */
