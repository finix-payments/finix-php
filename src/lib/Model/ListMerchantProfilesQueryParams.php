...
/**
 * ListMerchantProfilesQueryParams Class Doc Comment
 *
 * @category Class
 * @package  Finix
 * @author   Finix
 ...
 */
class ListMerchantProfilesQueryParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListMerchantProfilesQueryParams';
