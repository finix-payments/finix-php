...
/**
 * ApplicationProfile Class Doc Comment
 *
 * @category Class
 * @package  Finix
 * @author   Finix
 ...
 */
class ApplicationProfile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationProfile';
     ...
     * Sets id
     *
     * @param string|null $id ID of the `application_profile` resource.
     *
     * @return self
     */
     ...
     * Sets fee_profile
     *
     * @param string|null $fee_profile The ID of the `Fee Profile` associated with the `Application`.
     *
     * @return self
     */
     ...
     * Sets risk_profile
     *
     * @param string|null $risk_profile The ID of the `risk_profile` that was created during provisioning.
     *
     * @return self
     */
     ...
     * Gets _links
     *
     * @return \Finix\Model\ApplicationProfileLinks|null
     */
     ...
     * Sets _links
     *
     * @param \Finix\Model\ApplicationProfileLinks|null $_links _links
     *
     * @return self
     */
