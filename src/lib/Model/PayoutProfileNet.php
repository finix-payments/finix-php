...
/**
 * PayoutProfileNet Class Doc Comment
 *
 * @category Class
 ...
 */
class PayoutProfileNet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayoutProfile_net';
     ...
     * Sets frequency
     *
     * @param string|null $frequency Configures how frequentyly fees and payouts get credited. To configure a **CUSTOM** `frequency` [contact Finix Support](/guides/payouts/).
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_instrument_id The `id` of the `Payment Instrument` that payouts and fees get credited to and debited from.
     *
     * @return self
     */
     ...
     * Sets rail
     *
     * @param string|null $rail Configures how quickly and which payment `rail` will be used to debit fees and credit payouts.
     *
     * @return self
     */
     ...
     *
     * @param int|null $submission_delay_days Include a number of `submission_delay_days` to delay when `funding_transfers` for both payouts and fees will get submitted (in days) to debit/credit the `payment_instrument_id`.
     *
     * @return self
     */
