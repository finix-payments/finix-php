 ...
 */
class PageCursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageCursor';
     ...
     * Sets next_cursor
     *
     * @param string|null $next_cursor The cursor to use for the next page of results.
     *
     * @return self
     */
