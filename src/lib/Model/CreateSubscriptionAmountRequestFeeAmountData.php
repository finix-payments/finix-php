...
/**
 * CreateSubscriptionAmountRequestFeeAmountData Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateSubscriptionAmountRequestFeeAmountData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSubscriptionAmountRequest_fee_amount_data';
     ...
     * Sets amount
     *
     * @param int $amount A positive integer in cents representing how much to charge on a recurring basis.
     *
     * @return self
     */
