...
/**
 * IdentityAdditionalUnderwritingData Class Doc Comment
 *
 * @category Class
 ...
 */
class IdentityAdditionalUnderwritingData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Identity_additional_underwriting_data';
    ...
    protected static $openAPITypes = [
        ...
        'card_volume_distribution' => '\Finix\Model\IdentityAdditionalUnderwritingDataCardVolumeDistribution',
        ...
        'volume_distribution_by_business_type' => '\Finix\Model\IdentityAdditionalUnderwritingDataVolumeDistributionByBusinessType'
    ];
    ...
    public const REFUND_POLICY_WITHIN_30_DAYS = 'WITHIN_30_DAYS';
    public const REFUND_POLICY_OTHER = 'OTHER';
    ...
    public function getRefundPolicyAllowableValues()
    {
        return [
            ...
            self::REFUND_POLICY_WITHIN_30_DAYS,
            self::REFUND_POLICY_OTHER,
        ];
    }
    ...
    public function setBusinessDescription($business_description, $deserialize = false)
    {
        ...
        if (!is_null($business_description) && (mb_strlen($business_description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $business_description when calling IdentityAdditionalUnderwritingData., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \Finix\Model\IdentityAdditionalUnderwritingDataCardVolumeDistribution|null
     */
     ...
     *
     * @param \Finix\Model\IdentityAdditionalUnderwritingDataCardVolumeDistribution|null $card_volume_distribution card_volume_distribution
     *
     * @return self
     */
    ...
    public function setCreditCheckIpAddress($credit_check_ip_address, $deserialize = false)
    {
        ...
        if (!is_null($credit_check_ip_address) && (mb_strlen($credit_check_ip_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $credit_check_ip_address when calling IdentityAdditionalUnderwritingData., must be bigger than or equal to 1.');
        }
    ...
    public function setCreditCheckTimestamp($credit_check_timestamp, $deserialize = false)
    {
        ...
        if (!is_null($credit_check_timestamp) && (mb_strlen($credit_check_timestamp) < 1)) {
            throw new \InvalidArgumentException('invalid length for $credit_check_timestamp when calling IdentityAdditionalUnderwritingData., must be bigger than or equal to 1.');
        }
    ...
    public function setCreditCheckUserAgent($credit_check_user_agent, $deserialize = false)
    {
        ...
        if (!is_null($credit_check_user_agent) && (mb_strlen($credit_check_user_agent) < 1)) {
            throw new \InvalidArgumentException('invalid length for $credit_check_user_agent when calling IdentityAdditionalUnderwritingData., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantAgreementIpAddress($merchant_agreement_ip_address, $deserialize = false)
    {
        ...
        if (!is_null($merchant_agreement_ip_address) && (mb_strlen($merchant_agreement_ip_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $merchant_agreement_ip_address when calling IdentityAdditionalUnderwritingData., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantAgreementTimestamp($merchant_agreement_timestamp, $deserialize = false)
    {
        ...
        if (!is_null($merchant_agreement_timestamp) && (mb_strlen($merchant_agreement_timestamp) < 1)) {
            throw new \InvalidArgumentException('invalid length for $merchant_agreement_timestamp when calling IdentityAdditionalUnderwritingData., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantAgreementUserAgent($merchant_agreement_user_agent, $deserialize = false)
    {
        ...
        if (!is_null($merchant_agreement_user_agent) && (mb_strlen($merchant_agreement_user_agent) < 1)) {
            throw new \InvalidArgumentException('invalid length for $merchant_agreement_user_agent when calling IdentityAdditionalUnderwritingData., must be bigger than or equal to 1.');
        }
    ...
    public function setRefundPolicy($refund_policy, $deserialize = false)
    {
        ...
        if (!is_null($refund_policy) && (mb_strlen($refund_policy) < 1)) {
            throw new \InvalidArgumentException('invalid length for $refund_policy when calling IdentityAdditionalUnderwritingData., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \Finix\Model\IdentityAdditionalUnderwritingDataVolumeDistributionByBusinessType|null
     */
     ...
     *
     * @param \Finix\Model\IdentityAdditionalUnderwritingDataVolumeDistributionByBusinessType|null $volume_distribution_by_business_type volume_distribution_by_business_type
     *
     * @return self
     */
