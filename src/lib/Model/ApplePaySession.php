...
/**
 * ApplePaySession Class Doc Comment
 *
 * @category Class
 * @package  Finix
 * @author   Finix
 ...
 */
class ApplePaySession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplePaySession';
     ...
     * Sets id
     *
     * @param string|null $id The ID of the `apple_pay_session` resource.
     *
     * @return self
     */
     ...
     *
     * @param string|null $session_details Details about the `apple_pay_session` that was created.
     *
     * @return self
     */
