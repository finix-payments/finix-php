...
/**
 * ListPaymentInstrumentVerificationsQueryParams Class Doc Comment
 *
 * @category Class
 * @package  Finix
 * @author   Finix
 ...
 */
class ListPaymentInstrumentVerificationsQueryParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListPaymentInstrumentVerificationsQueryParams';
