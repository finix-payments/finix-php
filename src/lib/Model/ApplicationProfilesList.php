...
/**
 * ApplicationProfilesList Class Doc Comment
 *
 * @category Class
 * @package  Finix
 * @author   Finix
 ...
 */
class ApplicationProfilesList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationProfilesList';
     ...
     * Gets _embedded
     *
     * @return \Finix\Model\ApplicationProfilesListEmbedded|null
     */
     ...
     * Sets _embedded
     *
     * @param \Finix\Model\ApplicationProfilesListEmbedded|null $_embedded _embedded
     *
     * @return self
     */
