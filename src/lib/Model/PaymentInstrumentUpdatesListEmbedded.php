 ...
 */
class PaymentInstrumentUpdatesListEmbedded implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentInstrumentUpdatesList__embedded';
    ...
    protected static $openAPITypes = [
        'updates' => '\Finix\Model\InstrumentUpdate[]'
    ];
