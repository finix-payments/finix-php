...
/**
 * UsersListPage Class Doc Comment
 *
 * @category Class
 ...
 */
class UsersListPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UsersList_page';
     ...
     * Sets count
     *
     * @param int|null $count The number of entries returned.
     *
     * @return self
     */
