...
/**
 * AdjustmentTransfersList Class Doc Comment
 *
 * @category Class
 * @package  Finix
 * @author   Finix
 ...
 */
class AdjustmentTransfersList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdjustmentTransfersList';
     ...
     * Gets _embedded
     *
     * @return \Finix\Model\AdjustmentTransfersListEmbedded|null
     */
     ...
     * Sets _embedded
     *
     * @param \Finix\Model\AdjustmentTransfersListEmbedded|null $_embedded _embedded
     *
     * @return self
     */
