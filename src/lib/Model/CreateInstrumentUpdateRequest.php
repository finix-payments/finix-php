...
/**
 * CreateInstrumentUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  Finix
 * @author   Finix
 ...
 */
class CreateInstrumentUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateInstrumentUpdateRequest';
     ...
     * Sets file
     *
     * @param \SplFileObject|null $file The binary contents of the file.
     *
     * @return self
     */
